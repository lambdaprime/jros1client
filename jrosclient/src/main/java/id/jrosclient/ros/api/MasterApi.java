...
public interface MasterApi {
    ...
    /**
     * <p>
     * Retrieve list representation of system state (for example available
     ...
     * @param callerApi URI of publisher API to register (other nodes will use that
     *                  API to subscribe for the topic)
    ...
    /**
     * Unregister the caller from being publisher of the topic. Unregistration will
     ...
     * @return number of unregistered publishers. If it is zero it means that the
     *         caller was not registered as a publisher. The call still succeeds as
     ...
     * @param topic     Fully-qualified name of the topic
     * @param topicType Type of the messages in the given topic
     * @param callerApi URI of subscriber API to register. If topic is not yet
     *                  available it will be used later to notify new publisher
     *                  about already active subscribers.
