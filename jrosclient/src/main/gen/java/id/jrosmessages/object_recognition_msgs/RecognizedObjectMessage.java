 ...
 * 
 * Generated for ROS msg file: object_recognition_msgs/RecognizedObject
 */
...
import id.jrosmessages.geometry_msgs.PoseWithCovarianceStampedMessage;
...
public class RecognizedObjectMessage implements Message {
    ...
    /**
     * Contains information about the type and the position of a found object Some
     * of those fields might not be filled because the used techniques do not fill
     * them or because the user does not request them The type of the found object
     */
    @Streamed
    public ObjectTypeMessage type = new ObjectTypeMessage();

    /**
     * confidence: how sure you are it is that object and not another one. It is
     * between 0 and 1 and the closer to one it is the better
     */
    @Streamed
     ...
     * frames of the original sensors (it is an array as you might have several
     * sensors)
     */
    @Streamed
    ...
    /**
     * Sometimes, you can only provide a bounding box/shape, even in 3d This is in
     * the pose frame
     */
    @Streamed
     ...
     * get a contour, or a box The last point will be linked to the first one
     * automatically
     */
    @Streamed
     ...
     * the input. The units are radian/meters as usual
     */
    @Streamed
