...
/**
 * Definition for trajectory_msgs/JointTrajectoryPoint Each trajectory point
 * specifies either positions[, velocities[, accelerations]] # or positions[,
 * effort] for the trajectory to be executed. # All specified values are in the
 * same order as the joint names in JointTrajectory.msg
 */
@MessageMetadata(type = JointTrajectoryPointMessage.NAME, md5sum = "0b7b3d8dcc88390331fe8287246f673f")
