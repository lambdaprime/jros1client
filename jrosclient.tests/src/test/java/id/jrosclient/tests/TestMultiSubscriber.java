...
/**
 * Subscriber which can be subscribed to multiple publishers and test that each
 * of them publishes certain number of items.
 */
public class TestMultiSubscriber implements Subscriber<Integer> {
    ...
    /**
     * By default subscriber cancels the subscription when it receives all items
     * from all publishers. With this flag it will keep continue requesting items
     * forever.
     */
    ...
    /**
     * Set future which will be completed once subscriber receives all items from
     * all publishers
     */
