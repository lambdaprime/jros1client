...
public interface NodeApi {
    ...
    /**
     * Publisher node API method called by a subscriber node. It requests publisher
     * node to allocate a channel for communication. Subscriber provides a list of
     * desired protocols for communication. Publisher returns the selected protocol
     * along with any additional parameters required for establishing connection.
     * For example, for a TCP/IP-based connection, the publisher node may return a
     * port number of its TCP/IP server.
     * 
