 ...
 * 
 * Generated for ROS msg file: sensor_msgs/MultiDOFJointState
 */
...
/**
 * Definition for sensor_msgs/MultiDOFJointState Representation of state for
 * joints with multiple degrees of freedom, # following the structure of
 * JointState. # # It is assumed that a joint in a system corresponds to a
 * transform that gets applied # along the kinematic chain. For example, a
 * planar joint (as in URDF) is 3DOF (x, y, yaw) # and those 3DOF can be
 * expressed as a transformation matrix, and that transformation # matrix can be
 * converted back to (x, y, yaw) # # Each joint is uniquely identified by its
 * name # The header specifies the time at which the joint states were recorded.
 ...
 * empty. # # All arrays in this message should have the same size, or be empty.
