...
public class TcpRosServer implements MessageService, AutoCloseable {
    ...
    private ConnectionHeaderValidator headerValidator = new ConnectionHeaderValidator(metadataAccessor);
    ...
    public CompletableFuture<MessageResponse> process(ByteBuffer message) {
        ...
        var reader = new ConnectionHeaderReader(dis);
        var header = Unchecked.get(reader::read);
        ...
        publisher.subscribe(new TopicPublisherSubscriber(future));
